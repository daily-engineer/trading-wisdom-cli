...
class MAStrategy(Strategy):
    ...
    def __init__(self, config: Optional[StrategyConfig] = None, **params):
        ...
        self.parameters = {"fast_period": 10, "slow_period": 30, **params}
    ...
    def generate_signal(self, data: dict) -> Signal:
        ...
        fast = TechnicalIndicators.ema(df["close"], self.parameters["fast_period"])
        slow = TechnicalIndicators.ema(df["close"], self.parameters["slow_period"])
...
class RSIStrategy(Strategy):
    ...
    def __init__(self, config: Optional[StrategyConfig] = None, **params):
        ...
        self.parameters = {"period": 14, "oversold": 30, "overbought": 70, **params}
    ...
    def generate_signal(self, data: dict) -> Signal:
        ...
        if current_rsi < self.parameters["oversold"]:
            strength = (self.parameters["oversold"] - current_rsi) / self.parameters[
                "oversold"
            ]
            return Signal(
                symbol=symbol,
...
class MACDStrategy(Strategy):
    ...
    def __init__(self, config: Optional[StrategyConfig] = None, **params):
        ...
        self.parameters = {"fast": 12, "slow": 26, "signal": 9, **params}
...
class BollingerStrategy(Strategy):
    ...
    def __init__(self, config: Optional[StrategyConfig] = None, **params):
        ...
        self.parameters = {"period": 20, "std_dev": 2.0, **params}
    ...
    def generate_signal(self, data: dict) -> Signal:
        ...
        upper, middle, lower = TechnicalIndicators.bollinger_bands(
            df["close"], self.parameters["period"], self.parameters["std_dev"]
        )
